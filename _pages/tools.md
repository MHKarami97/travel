...
<h2>کمک‌های اولیه</h2>
<p>داشتن وسایل کمک‌های اولیه از ملزومات سفر است، هرچند در صورت مراقب بودن افراد مشکل خاصی در سفر ایجاد نمی‌شود ولی در صورت بروز مشکل این وسایل بسیار کاربردی هستند.  
...
<h2>چاقو</h2>
<p>چاقو در سفر کاربردهای مختلفی مانند درست کردن غذا، بریدن چوب، دفاع در برابر حیوانات را دارد.  
...
چاقو سمت چپ وزن نسبتا زیادی دارد و بجای آن پیشنهاد می‌کنم از چاقوهای برند کلمبیا که تاشو نیستند و بر روی پا هم بسته می‌شوند استفاده کنید.  </P>
...
<h2>لوازم کاربردی</h2>
<p>در عکس زیر بعضی وسایل که کاربردهای شخصی دارند را مشاهده می‌کنید. این وسایل را هم می‌توانید در بسته‌های آخر مطلب قرار دهید. این وسایل هم وزن کمی دارند.  
...
<h2>پخت‌و‌پز</h2>
<p>برای پخت غذا علاوه بر ظرف به وسایل دیگری هم نیاز دارید که در عکس زیر می‌توانید آنها را مشاهده کنید.  
...
<h2>شست‌و‌شو</h2>
<p>برای شستن ظروف و همچنین خودتان در سفرهای چند روزه به وسایل زیر هم نیاز دارید:  `اسکاج، مایع ظرف‌شویی، شامپو`</P>
...
<h2>عینک</h2>
<p>با توجه به اینکه در طبیعت ساعت‌های زیادی را زیر آفتاب هستید، داشتن یک عینک خوب برای محافظت از چشم‌ها مهم است.  
...
نگهداری عینک را هم مهم است که در اینترنت درباره آن می‌توانید مطالعه کنید.  </P>
...
<h2>کلاه</h2>
<p>با توجه به موردی که در بالا گفته شد، داشتن پوشش مناسب برای جلوگیری از سوختگی مهم است.  
...
همچنین برای محافظ از صورت می‌توانید از اسکارف‌های توری هم استفاده کنید.  </P>
...
<h2>کیسه‌خواب</h2>
<p>داشتن خواب کافی و مناسب در کوهنوردی بسیار مهم است تا در روزهای بعد انرژی کافی برای برای انجام کارها را داشته باشید.  
...
همچنین می‌توانید 2 کیسه خواب بخرید و با توجه به شرایط یکی از آنها را ببرید.  
...
همچنین برای آن حتما کیسه حمل هم بگیرید تا زمان پیمایش پاره نشود.  
</P>
...
<h2>چادر</h2>
<p>داشتن چادر مناسب برای محافظت در برابر حشرات و همچنین سرما در کوهنوردی مهم است. چادرهای کوهنوردی در اندازه‌های `1 نفره، 2 نفره، 2+1 نفره، 4 نفره` درست می‌شوند که نوع 2 نفره آن بیشتر کاربرد دارد. شبیه وسایل دیگر چادر را هم می‌توانید با همگروهی خود تقسیم کنید تا یک نفر تمام آن را حمل نکند.  
...
البته زیرانداز فقط برای نشستن فرق دارد که در عکس‌های بعدی می‌توانید آن را مشاهده کنید.  </P>
